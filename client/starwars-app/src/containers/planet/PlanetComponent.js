...
const PeopleComponent = () => {
    ...
    return (
        ...
        <input className="mb-8 bg-gray-200 appearance-none border-2 border-gray-200 rounded  py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="text" placeholder="Add planet" value={searchTerm} onChange={handleChange}/>
            {searchTerm !== '' ? 
            <div>
                  ...
                  <Card className="min-w-full border-solid border-4 border-indigo-900">
                    <CardContent >
                        ...
                        <Typography  variant="body2" component="p">
                            <p  className="font-bold flex">Population </p>
                            {people.population}
                        </Typography>
                      
                        <Typography c variant="body2" component="p">
                            <p  className="font-bold flex">Orbital Period </p>
                            {people.orbital_period}
                        </Typography>

                        <Typography  variant="body2" component="p">
                            <p  className="font-bold flex">Climate </p>
                            {people.climate}
                        </Typography>
                    </CardContent>
            ...
            { products.map((people) => (
                ...
                <Card className="min-w-full border-solid border-4 border-indigo-900">
                    <CardContent>
                        ...
                        <Typography  variant="body2" component="p">
                            <p  className="font-bold flex">Terrain </p>
                            {people.terrain}
                        </Typography>
                    </CardContent>
                    <CardActions className="text-center justify-center mx-auto">
                        <Link to={`/planet/${people.id}`}>
